...
*   jQuery UI v1.8+
*
* NOTE: I have modified this script in three ways:
*
* 1. made it requirejs-compliant
* 2. pasted in the changes from https://github.com/aehlke/tag-it/pull/147 so
*    that a confirm dialog does not cause the "double tag insert" bug.
* 3. pasted in the `updateTags` method from
*    https://github.com/aehlke/tag-it/pull/311.
*/
