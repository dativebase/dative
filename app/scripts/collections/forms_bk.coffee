define [
  ...
  class FormsCollection extends Backbone.Collection
    ...
    # GET `<CorpusServiceURL>/<dbname>/_design/pages/_view/
    ...
    getFetchAllFieldDBFormsURL: ->
      ...
      "#{url}/#{dbname}/_design/pages/_view/datums_chronological"
    ...
    # GET `<CorpusServiceURL>/<dbname>/_design/pages/_view/datums_chronological`
    # TODO: Deprecate this.
        ...
        onload: (responseJSON) =>
          ...
          if responseJSON.rows
            ...
            Backbone.trigger 'fetchAllFieldDBFormsFail',
              "Failed in fetching the data. #{reason}"
            console.log "request to datums_chronological failed; reason:
              #{reason}"
        onerror: (responseJSON) =>
          console.log 'Error in request to datums_chronological'
          Backbone.trigger 'fetchAllFieldDBFormsEnd'
