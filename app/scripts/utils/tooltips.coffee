define ['./utils'], (utils) ->
  ...
  datetimeEntered =
    eng: (options) ->
      if options.value and options.resourceName
        "This #{utils.singularize options.resourceName} was entered on
  ...
  datetimeModified =
    eng: (options) ->
      if options.value and options.resourceName
        "This #{utils.singularize options.resourceName} was last modified on
          #{utils.humanDatetime options.value}"
      else
  ...
  enterer =
    eng: (options) ->
      if options.resourceName
        tmp = utils.singularize options.resourceName
      else
        tmp = 'resource'
  ...
  name =
    eng: (options) ->
      if options.resourceName
        resourceName = utils.singularize options.resourceName
        resourceNamePlural = options.resourceName
      else
  ...
  description =
    eng: (options) ->
      if options.resourceName
        "A description of the #{utils.singularize options.resourceName}."
      else
        "A description of the resource."

  id =
    eng: (options) ->
      "The id of the #{utils.singularize options.resourceName}. This is an
      integer generated by the relational database that is used by the OLD.
      This value can be used to uniquely identify the
      #{utils.singularize options.resourceName}."

  uuid =
    eng: (options) ->
      "The UUID (universally unique identifier) of the
      #{utils.singularize options.resourceName}. This is a unique value
      generated by the OLD. It is used to create references between
      #{options.resourceName} and their previous versions."
