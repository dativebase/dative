      ...
      forms:
        ...
        grammaticality:
          eng: "The grammaticality of the form, e.g., grammatical, ungrammatical,
            questionable, infelicitous in a given context. Possible values are
            defined in the application settings and can be modified by
            administrators."

        # TODO: put in help document: "A sequence of categories and morpheme
        # delimiters (a sequence of parts-of-speech) corresponding to the
        # morphological composition of the words in the form. If the form is
        # mono-morphemic, then this value should be the same as the syntactic
        # category value. The syntactic category string value is generated by
        # the OLD based on the morpheme break and morpheme gloss values
        # supplied by the user and the syntactic category of the morphemes
        # implicit in those values. If, for example, a form has a morpheme
        # break value of “chien-s” and a morpheme gloss value of
        # “dog-PL”, and if the database contains lexical entries for
        # “chien/dog” and “s/PL” with categories “N” and “Num”, respectively,
        # then the syntactic category string value generated will be
        # “N-Num”. Note that the OLD does not allow the syntactic category
        # string to be explicitly defined by the user; this is by design: the
        # idea is to encourage you to build a lexicon, a verbicon, a phrasicon,
        # and a text collection simultaneously. You get more accurate syntactic
        # category strings by increasing the consistency between your lexicon
        # of morphemes and your lexicon of morphologically analyzed
        # phrase-level forms."
        syntactic_category_string:
          eng: "A sequence of categories (and morpheme delimiters) that is
        ...
        # TODO: put in help docs: Some examples: “N”, “S”, “Phi”, “Asp”, “JJ”, etc."
        syntactic_category:
          eng: "The category (syntactic and/or morphological) of the form."
        ...
        # TODO: put in help docs: "Note that the tags “foreign word” and
        # “restricted” have special meaning in the OLD."
        tags:
          eng: "Tags for categorizing your forms."
        ...
        enterer:
          eng: "The user who entered/created the form. This value is
            specified automatically by the application."

        modifier:
          eng: "The user who made the most recent modification to this
            form. This value is specified automatically by the application."

        verifier:
          eng: "The user who has verified the reliability/accuracy of
            this form."
        ...
        files:
          eng: "Digital files (e.g., audio, video, image or text) that are
            associated to this form."

        collections:
          eng: "Collections, i.e., texts (e.g., papers, elicitation records,
            etc.), that this form is a part of."


        # TODO: put in help document: "The break/gloss/category value is
        # generated by the OLD based on the morpheme break and morpheme gloss
        # values and the (also auto-generated) syntactic category string value.
        # The break/gloss/category value is a serialization of these three
        # values. A form with “chien-s” as morpheme break, “dog-PL” as morpheme
        ...
        break_gloss_category:
          eng: "The morpheme break, morpheme gloss and (syntactic) category
        ...
        # TODO: put in help document: "The OLD assumes that this will be a tree
        # in bracket notation using Penn Treebank conventions."
        syntax:
        ...
        status:
          eng: "The status of the form: “tested” for data that have been
            elicited/tested/verified with a consultant or “requires
            testing” for data that are posited and still need
            testing/elicitation."

        UUID:
          eng: "The UUID (universally unique identifier) of the form. A unique
            value generated by the system, this is used to create references
            between forms and their previous versions."

        id:
          eng: "The id of the form. An system-generated integer that is unique
            to each form."
        ...
        translations:
          eng: "One or more translations for the form. Each translation may
            have its own grammaticality/acceptibility specification."

          transcription:
            eng: "A transcription of a possible translation of this form."

          # Note: this should be changed to "appropriateness" in the OLD.
          grammaticality:
            eng: "The appropriateness of this translation with respect to this
              form."
